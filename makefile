...
default: ${LIBNAME}.${libsuffix}
build: ${LIBNAME}.${libsuffix}
...
embed-install update: ${PKGNAME}.${libsuffix}
	@if test -d ../../../lib/kno; then \
	  cp ${PKGNAME}.${libsuffix} ../../../lib/kno; \
	  echo "Updated $(abspath ../../../lib/kno/${PKGNAME}.${libsuffix})"; \
